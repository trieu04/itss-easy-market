...
// import { MealPlan, Recipe } from '../../contexts/AppContext';
...
// export const MealPlannerTab: React.FC<MealPlannerTabProps> = ({ mealPlans, recipes, dispatch }) => {
...
//         <h3 className="text-xl font-semibold text-gray-900">Lập kế hoạch bữa ăn</h3>
